...
# ╔═╡ e3d4f7b2-df52-11f0-8ee8-43e8d00d8292
begin
	using Plots
...
# ╔═╡ 9ddbbbca-c6a6-4edf-afb9-a8d299f6c91c
begin
	distro = MixtureModel(
		Normal[
			Normal(-6.0, 0.2),
	...
	xs = range(-8, 8, length=250)
	distro_pdf = pdf.(distro, xs)

	samples = rand(distro, 1, 10000)
end;

# ╔═╡ 986b6810-3c90-4e4c-8733-45e0c0fc0fc4
begin
	grid_bimodal = initialize_grid([xs], device=:cpu)
	estimation_gradepro = initialize_estimation(
		samples, grid=grid_bimodal, device=:cpu
	)
...
ParallelKDE = "251f600b-d60c-4092-b1b9-465b74160c73"
...
manifest_format = "2.0"
project_hash = "e5ab143778342912cef2207972c009d53a520d3c"
...
[[deps.ParallelKDE]]
deps = ["CUDA", "FFTW", "LinearAlgebra", "StaticArrays", "Statistics", "StatsBase"]
git-tree-sha1 = "405e757506256625d31c83b3ab221939e3fa5309"
